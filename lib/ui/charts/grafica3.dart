...
class Grafica3 extends StatefulWidget {
  Grafica3({Key key}) : super(key: key);

  @override
  _Grafica3State createState() => _Grafica3State();
}

class _Grafica3State extends State<Grafica3> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Horizontal Bar Label'),
      ),
      body: isLoading ? Center( child: CircularProgressIndicator() ) : HorizontalBarLabelChart.withDataFromApi(),
    );
  }
}
...
class HorizontalBarLabelChart extends StatelessWidget {
  ...
  factory HorizontalBarLabelChart.withDataFromApi() {
    return new HorizontalBarLabelChart(
      _createDataFromApi(),
      // Disable animations for image tests.
      animate: false,
